...
function Invoke-ProGetNativeApiMethod
{
    ...
    Demonstrates how to call `Invoke-ProGetNativeApiMethod`. In this example, it is calling the
    `Feeds_CreateOrUpdateProGetFeed` method to create a new Universal feed named `Apps`.
    #>
    ...
    param(
        ...
        # `http://inedo.com/support/documentation/proget/reference/api/native` or in your ProGet installation at
        # `/reference/api/native`
        [Parameter(Mandatory)]
        [String] $Name,
